<div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="name" type="text" id="name" value="{{ $supplier->name or ''}}" >
...
<div class="form-group {{ $errors->has('phoneNumber') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="phoneNumber" type="text" id="phoneNumber" value="{{ $supplier->phoneNumber or ''}}" >
